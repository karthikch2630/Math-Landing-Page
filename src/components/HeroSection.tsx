    ...
    >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start items-center mt-8">
              <Link to="/assessment">
                <button 
                  ...
                  type="button"
                  aria-label="Check your child's math learning roadmap"
                >
                  Check Roadmap
              ...
              <a href="tel:+917396669430" className="sm:w-auto">
                <button 
                  className="inline-flex items-center justify-center gap-3 border-2 border-yellow-400 text-gray-900 hover:bg-yellow-400 px-8 md:px-10 py-4 rounded-full text-lg font-bold transition duration-300 shadow-lg hover:shadow-2xl"
                  type="button"
                  aria-label="Book a math assessment call"
                >
                  Book Assessment
                  <ArrowRight className="w-5 h-5" />
                </button>
          ...
          <div className="relative flex justify-center lg:justify-end">
            <div className="relative w-full max-w-[400px] sm:max-w-[450px] md:max-w-[500px] z-20 overflow-hidden">
              <img
                src="/banner_img.png"
                alt="Student studying math with a tutor"
      ...
      <div className="fixed right-4 bottom-4 flex flex-col gap-3 z-50">
        ...
        <a
          ...
          aria-label="Call us for a math assessment"
        >
